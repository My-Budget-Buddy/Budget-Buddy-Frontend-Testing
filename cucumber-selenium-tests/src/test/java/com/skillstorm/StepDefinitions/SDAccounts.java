...
public class SDAccounts {
    ...
    /**
     * This method finds and clicks on a button on the Accounts page that cannot be
     * found by id.
     * 
     * @param btnName
     */
    ...
    public void myNetCashBarTurnsRed() {
        ...
        // Check if the net cash is larger than 0 - this is because net is calculated as
        // absoulte value
    ...
    /**
     * This method checks to make sure the accordian list is displayed on the
     * Accounts page after the button was clicked.
     * 
    ...
    public void iAddAAccountWithTheInformation(String accountType, String institutionName, String accountNumber,
            String routingNumber, String balance) {
        // Load the page
        page = new AccountsPage(driver);
     ...
     * @param balance         - the balance of the account
     */
    private void saveAccountInfo(String accountType, String institutionName, String accountNumber, String routingNumber,
            String balance) {
