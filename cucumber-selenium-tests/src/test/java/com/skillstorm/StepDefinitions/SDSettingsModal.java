...
public class SDSettingsModal {
    ...
    DashboardPage page;
    Navigator navigator;
    User user = new User(UserType.NONPERSISTANT, Authenticator.USERNAME_NONPERSIST_TWO, Authenticator.PASSWORD_NONPERSIST_TWO);
    ...
    public void iShouldBeAbleToLogInWithMyNewPassword() {
        navigator.navigateTo(Navigator.PGNAME_LOGIN);
        LoginPage loginPage = new LoginPage(driver);
        User newUser = new User(UserType.NONPERSISTANT, Authenticator.USERNAME_NONPERSIST_TWO,
                "thenewpassword");
