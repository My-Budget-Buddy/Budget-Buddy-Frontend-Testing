Feature:
    ...
    Scenario: DB1 - looking at drop down options when logged in
        ...
        When I click on the Accounts "<option>" option
        Then I can see the Accounts "<list>"
    ...
    Scenario: AC2 - Creating a new account
        ...
        When I click the "Add Account" button on Accounts page
    ...
    Scenario: AC4 - Viewing account information
        Given I am on the "Accounts" page
        When I click the "Get Report" button on Accounts page
